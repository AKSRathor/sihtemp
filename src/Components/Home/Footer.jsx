    ...
    <div className='w-full bg-white py-24'>
        <div className='md:max-w-[1480px] m-auto grid md:grid-cols-5 max-[780px]:grid-cols-2  gap-8 max-w-[600px]  px-4 md:px-0'>
            ...
            <div>
                ...
                <ul className='py-6 text-[#6D737A]'>
                    <li className='py-2'>Large household appliances</li>
                    <li className='py-2'>Small household appliances</li>
                    <li className='py-2'>Lighting equipment</li>
                    <li className='py-2'>Cables and wiring</li>
                    <li className='py-2'>Batteries</li>
                    <li className='py-2'>Medical devices</li>
